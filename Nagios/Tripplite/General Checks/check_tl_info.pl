...
my $tl_type             = ".1.3.6.1.4.1.850.1.1.1.2.1.5.1";
my $tl_firmware         = ".1.3.6.1.4.1.850.1.1.2.1.1.4.1";
my $tl_paversion        = ".1.3.6.1.4.1.850.1.2.1.1.2.0";

my @array_of_oids       = ($tl_type,$tl_firmware,$tl_paversion);
...
########### TrippLite UPS Output Source Check ############
if (defined ($o_netsnmp)) {
 ...
 $type = $$resultat{$tl_type};
 $firmware = $$resultat{$tl_firmware};
 $paversion = $$resultat{$tl_paversion};
 #print "source is *$source*\n";  #testing

 $n_output = "Device Model: " . $type . "; Device Firmware: " . $firmware . "; PowerAlert Version: " . $paversion;
