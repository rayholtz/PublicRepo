...
my $ups_battstatus          = ".1.3.6.1.4.1.850.1.1.3.1.3.1.1.1.1.1";
my @array_of_oids       = ($ups_battstatus);
...
########### TrippLite UPS Battery Status Check ############
if (defined ($o_netsnmp)) {
 ...
 $source = $$resultat{$ups_battstatus};
 #print "source is *$source*\n";  #testing

 use Switch;

 switch($source) {
    case "1"   { $n_output = "Battery Status is '1', UNKNOWN."; $n_status="CRITICAL";  }
    case "2"   { $n_output = "Battery Status is '2', Normal."; $n_status="OK"; }
    case "3"   { $n_output = "Battery Status is '3', LOW."; $n_status="CRITICAL"; }
    case "4"   { $n_output = "Battery Status is '4', DEPLEATED."; $n_status="CRITICAL"; }
