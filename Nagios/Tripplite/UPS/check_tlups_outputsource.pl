...
#################################################################
#
# Help : ./check_tlups_outputsource.pl -h
#
...
if (defined ($o_netsnmp)) {
 ...
 $source = $$resultat{$ups_outputsource};
 ...
 #   the output breaker.
 #  INTEGER {unknown(0), other(1), none(2), normal(3), bypass(4), battery(5),
 #    boosting(6), reducing(7), second(8), economy(9) }
